...
public class War : MonoBehaviour
{
    ...
    private int GetCardRank(Sprite cardSprite)
    {
        ...
        string[] cardName = cardSprite.name.Split(' ');
    ...
    {
        if (playerTurn == PlayerTurn.PLAYER1) { playerTurn = PlayerTurn.PLAYER2; player1Stack.enabled = false; player1Stack.enabled = true; }
